...
```javascript
Laravel Excel 2.0 的版本和 3.0 的版本有很大的区别，使用 composer 加载的时候要注意版本，3.0 和 2.0 的语法基本不同了
...
[Laravel 项目的简单 CMS](https://github.com/AlexStack/Laravel-CMS)

[Laravel 之道]( https://learnku.com/docs/the-laravel-way/5.6/Tao-1-1/2925)


Laravel 代码生成器 https://learnku.com/laravel/t/34772 https://github.com/GooGee/Entity-Builder

[使用 Docker LNMP 部署 PHP 开发环境 ](https://github.com/yanlongma/docker-lnmp)

[PHP-fpm MongoDB 连接数 ]( https://learnku.com/laravel/t/34780)


[ Laravel 源码写的一个简易框架](https://github.com/sheaxiang/shea)

[轻松部署 Laravel 应用 ](https://learnku.com/articles/34628)

接近免费的 SSL 证书 https://www.digital-sign.com.cn/register

一键生成 https 根域名证书更方便，推荐 certbot-auto 脚本

[Laravel 的开源api文档管理系统 Wizard ](https://github.com/mylxsw/wizard)

[CentOS7 轻松部署 Laravel 应用]( https://learnku.com/articles/34879)

[超大文件上传](https://github.com/peinhu/aetherupload-laravel)

[使用 AetherUpload 视频上传过程](https://learnku.com/articles/34568)

[axeadmin 让你的 Laravel 快速拥有一个后台](https://github.com/kphcdr/axeadmin-laravel)


[Laravel 的请求是怎么到达控制器](https://learnku.com/articles/34123)

[控制台实时查看 sql](https://github.com/eleven26/listen-sql)

[HTTP 协议免费升级到 HTTPS](https://learnku.com/articles/33400)

[ Laravel-echo-server 开发聊天室和客服功能](https://github.com/wmhello/laravel_template_with_vue)

[laravel之道](https://learnku.com/docs/the-laravel-way/5.6/Tao-1-1/2925)

[Laravel 代码生成工具](https://googee.github.io/Entity-Builder/dist/)

[Laravel 源码阅读 - Eloquent](https://learnku.com/articles/32007#replies)
...
[Laravel 从学徒到工匠精校版 ](https://laravelacademy.org/laravel-from-appreciate-to-artisan)

[服务容器](https://learnku.com/articles/32333)

[Laravel5.8 版本内核源码注解](https://github.com/immortalChensm/laravel5.8)

[Laravel-admin 源码分析系列](https://learnku.com/articles/32025)

[Laravel 源码阅读](https://learnku.com/articles/32007)

[Laravel 数据库脱敏工具](https://github.com/y-ui/laravel-data-masking)

[Laravel 深入浅出指南  ](https://github.com/xiaohuilam/laravel/wiki)

[Laravel5.5LTS 版本源码内核阅读注解](https://github.com/immortalChensm/laravel-work)

[laravel 源码详解https://github.com/LeoYang90/laravel-source-analysis](https://leoyang90.gitbooks.io/laravel-source-analysis/content/)

[Laravel + Vue + Oss 搭建的图片墙](https://github.com/shanyul/photosLive)

[基于 Laravel + Ant-design-pro 界面美观漂亮的后台](https://github.com/tangtanglove/fullstack-backend)

[Laravel-admin 安装分析](https://learnku.com/articles/32025)

[电子商务后台系统](https://github.com/imnotdoubi/laravel-admin.git)

[基于laravel的博客](https://learnku.com/laravel/t/31585)
...
[laravel5.5和vue.js结合的前后端分离项目模板websocket聊天室](https://github.com/wmhello/laravel_template_with_vue)